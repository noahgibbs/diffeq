...
# reproduces.  High alpha means lots of reproduction.
alpha = 1.0
...
# from the rate at which they eat prey.  High delta means more offspring.
delta = 0.3

# Gamma is the rate at which the predator dies off naturally.  High gamma
# means quicker exponential decay in the predator population.  Think of
# the predator as aging quicker or being more accident-prone.
gamma = 0.8
